...
def execute_on_shutdown():
    subprocess.call([r"192.168.0.77\\C:\Users\gnt\Desktop\release\번호판분석서버.exe"])

atexit.register(execute_on_shutdown)
...
def LPR_request(date,road, value, real_count, ex1, plate_7, plate_0to6, plate_8to9, plate_trash):
    ...
    for i in base64_list[value:]:
        ...
        c_count = sum("center_" in filename for filename in base64_list)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-rt', '--real_count', type=int, default=0, help='Add counts')
