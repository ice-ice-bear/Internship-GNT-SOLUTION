...
def copy_images(date, source_folder, destination_folder):
    ...
    for root, dirs, files in os.walk(source_folder):
        for file in files:
            if "center_" in file and "_yolo" not in file:
...
def main():
    ...
    parser.add_argument("-d", "--date", type=str, default="230601", help="The date of the images.")
    parser.add_argument("-s", "--source_dir", type=str, default="H:/01.수집데이터/01._마성터널_데이터/2023-06", help="The path to the source folder.")
    parser.add_argument("-t", "--destination_dir", type=str, default="R:/seatbelt/highway_send_data/ms", help="The path to the destination folder.")
