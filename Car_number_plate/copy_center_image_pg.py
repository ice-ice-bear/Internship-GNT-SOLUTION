...
def main():
    ...
    parser.add_argument("-s", "--source_dir", type=str, default="S:/04.seatbelt/01.수집데이터/[R2022-02]대왕판교_수집데이터/daewangpangyo", help="The path to the source folder.")
    parser.add_argument("-t", "--destination_dir", type=str, default="R:/seatbelt/highway_send_data/dp", help="The path to the destination folder.")
