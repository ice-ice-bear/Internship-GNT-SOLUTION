...
def main():
    """ 
    Title: Accesment_Datasheet(ver3.1)
    Platform: os, pandas, argparse, time, tqdm 
    Version: 0.3.1
    ...
    if differences:
        ...
        for line in differences:
            ...
            if any(word in line for word in banned_words):
                continue
            print(f"Genarating empty text file : {line}")
...
def assesment_datasheet(folder_path, folder_name, weight):
    ...
    def relocate_value():
        ...
        print("Relocating files completed")
    ...
    def make_answersheet(folder_path, folder_name, weight):
        ...
        print("Making answersheet completed")
