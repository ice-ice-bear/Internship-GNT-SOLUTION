...
def main():
    """ 
    Title: Accesment_Datasheet(ver5.0)
    ...
    Update: Changed the 'seat1' and 'seat3' answersheet condition since the algorithm changed since june
    """
        ...
        with tqdm(total=len(answer)/3) as pbar:
            for i in range(0, len(answer), 3):
                ...
                for j, k in enumerate(['1']):
                    values = [row1[k], row2[k]]
                    value1 = values[0]
                    value2 = values[1]

                    if value1 == 'emp':
                        answer.at[i, 'seat1'] = value2
                    elif value1 == 'O' or 'X':
                        answer.at[i, 'seat1'] = value1
                ...
                for j, k in enumerate(['3']):
                    ...
                    if value1 == 'emp':
                        answer.at[i, 'seat3'] = value2
                    elif value1 == 'O' or 'X':
                        answer.at[i, 'seat3'] = value1
